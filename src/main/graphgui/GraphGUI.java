...
public class GraphGUI extends Application implements ExtendedGraph.GraphObserver {
  ...
  public void start(Stage primaryStage) {
    ...
    menu11.setOnAction((ActionEvent event) -> {
      try {
    ...
    menu12.setOnAction((ActionEvent event) -> {
      try {
    ...
    menu13.setOnAction((ActionEvent event) -> {
      System.exit(0);
    });
    ...
    edel.setOnAction((ActionEvent event) -> {
      try {
    ...
    ebtn.setOnAction((ActionEvent event) -> {
      try {
    ...
    abtn.setOnAction((ActionEvent event) -> {
      try {
