...
public class GraphImplementation implements Graph {
    ...
    public VertexImplementation addVertex(double x, double y) {
        VertexImplementation v = new VertexImplementation(this,
                vertices.size(),
                x, y);
        vertices.add(v);
        return v;
    ...
    @Override
    public Iterable<Integer> adjVertexIds(int n)
    ...
    @Override
    public EdgeImplementation addEdge(Vertex v1, Vertex v2)
	...
	checkVertex(v2);
        ...
        EdgeImplementation res = EdgeImplementation.createEdgePair(this,
                                 vi1, vi2);
    ...
    @Override
    public void removeEdge(Vertex n1, Vertex n2)
    throws IllegalArgumentException
    {
    ...
    public void print(PrintStream out, boolean full) {
        ...
        for (Edge e : getEdges()) {
            out.println(e.getOriginId() + " " + e.getDestinationId()
                        + " " + e.getValue());
        }
    }
    ...
    public void read(Scanner s) throws DataFormatException {
        ...
        try {
            ...
            throw new DataFormatException("ten subor je nejaky divny ("
                                          + line + ")");
        }
    }
